        ...
        <table class='table'>
            ...
            <tr>           
                <td><span class='field-label'>SWARCO Lead Persons</span>
                    <div class='content'>
                        <div class='entry-value'><xsl:value-of select='/contact/other-list/other[label="Lead Persons"]/value'/></div>
                    </div>
                </td>
                <td><span class='field-label'>Finance</span>
                    <div class='content'>
                        <div class='entry-value'><xsl:value-of select='/contact/other-list/other[label="Finance"]/value'/></div>
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td><span class='field-label'>Value of the total contract (EUR)</span>
                    <div id='calculation878' class='content'>
                        <script type="text/javascript"> 
                ...
                <td><span class='field-label'>Value of SWARCO Part (EUR)</span>
                    <div id='calculation879' class='content'>
                        <script type="text/javascript"> 
            ...
            <tr>
                <td>
                    ...
                    <div class='content'>
                        <xsl:value-of select='/contact/other-list/other[label="Project Status"]/value'/> (<xsl:value-of select='/contact/other-list/other[label="Project Status Changed"]/value'/>)
                    </div>
                </td>
                <td><span class='field-label'>Project Opportunity Status</span>
                <div class='content'>
                    <center>
                <table style="border-collapse: collapse;">
                    <tr>
                        <td style="vertical-align: middle;">Initial Discussion:</td>
                        <td><xsl:value-of select='/contact/date-list/date[label="Initial Discussion"]/value1'/></td>
                    </tr>
                    <tr>
                        <td style="vertical-align: middle;">Prequalification:</td>
                        <td><xsl:value-of select='/contact/date-list/date[label="Prequalification"]/value1'/></td>
                    </tr>
                    <tr>
                        <td style="vertical-align: middle;">Tender:</td>
                        <td><xsl:value-of select='/contact/date-list/date[label="Tender"]/value1'/></td>
                    </tr>
                    <tr>
                        <td style="vertical-align: middle;">Post Tender Discussions:</td>
                        <td><xsl:value-of select='/contact/date-list/date[label="Post Tender Discussions"]/value1'/></td>
                    </tr>
                    <tr>
                        <td style="vertical-align: middle;">Cancelled:</td>
                        <td><xsl:value-of select='/contact/date-list/date[label="Cancelled"]/value1'/></td>
                    </tr>
                    <tr>
                        <td style="vertical-align: middle;">Delayed:</td>
                        <td><xsl:value-of select='/contact/date-list/date[label="Delayed"]/value1'/></td>
                    </tr>
                    <tr>
                        <td style="vertical-align: middle;">On Hold:</td>
                        <td><xsl:value-of select='/contact/date-list/date[label="On Hold"]/value1'/></td>
                    </tr>
                    <tr>
                        <td style="vertical-align: middle;">No-bid:</td>
                        <td><xsl:value-of select='/contact/date-list/date[label="No-bid"]/value1'/></td>
                    </tr>
                    <tr>
                        <td style="vertical-align: middle;">Lost:</td>
                        <td><xsl:value-of select='/contact/date-list/date[label="Lost"]/value1'/></td>
                    </tr>
                </table>
                    </center>
                </div>
