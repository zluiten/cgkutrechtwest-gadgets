...
$TMP_INSTALLDIR = '/gemeentegids/'; // UNIQUE part of the URL to the main directory leading to this application (e.g. 'tabr/'). Default / works for http://server/tabr but not for http://server/sub/tabr .
...
//$CONFIG_TAB_SERVER_ROOT = '/adresboek/';
...
$CONFIG_HEADER_HTML = '';
//$CONFIG_HEADER_HTML = '<H1><strong>Digitale gemeentegids CGK-Utrecht West</strong></H1>'; //'<iframe src="/index.php?page=empty" width="99%" height=160 scrolling=no>IFrame not found!</IFRAME>';
...
//$CONFIG_ADD_HEAD = '<title>Digitale gemeentegids CGK-Utrecht West</title>'; // add something between <HEAD> </HEAD>
...
$CONFIG_CLASS_POSING_ARRAY = array
    (
        // 'oldClass' => 'newClass'
        'PageDelegate' => 'MyPageDelegate',
        'PageContactEdit' => 'MyPageContactEdit',
        'PageContact' => 'MyPageContact'
        );
